...
public class BridgeUtil {
    ...
    final static String JS_HANDLE_MESSAGE_FROM_JAVA = "javascript:JKEventHandler._handleMessageFromNative('%s');";
    final static String JS_FETCH_QUEUE_FROM_JAVA = "javascript:JKEventHandler._fetchQueue();";
    public final static String JAVASCRIPT_STR = "javascript:";

    // 例子 javascript:JKEventHandler._fetchQueue(); --> _fetchQueue
    public static String parseFunctionName(String jsUrl){
        return jsUrl.replace("javascript:JKEventHandler.", "").replaceAll("\\(.*\\);", "");
    }
    ...
    /**
     * 这里只是加载lib包中assets中的 JKEventHandler.js
     * @param view webview
     * @param path 路径
     */
